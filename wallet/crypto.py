...
class KeyPair:
    ...
    def from_seed_phrase(cls, word_list):
        ...
        @param word_list: Array with strings.
        @return: KeyPair instance.
        """
        private_key = ec.derive_private_key(_generate_private_number(word_list),
                                            _curve,
                                            default_backend())
    ...
    def from_file(cls, key_file):
        """
        Creates a key pair from an array of seed words.
        @param key_file: Key-file created with save_as_file-function.
        @return: KeyPair instance.
        """
    ...
    def sign_data(self, data):
        ...
        """
        return self.private_key.sign(data, SIGN_ALGO)
    ...
    def verify(self, data, signature):
        ...
        """
        try:
            self._public_key.verify(signature, data, SIGN_ALGO)
            return True
...
def verify_signature(public_key_str, signature, sign_data):
    """
    Verifies that a given public key singed some given data.
    @param public_key_str: Public key.
